...
#   Frame is the Tkinter frame class that our own class will inheret from
class ParentWindow(Frame) :
        def __init__ (self, master, *args, **kwargs) :
                ...
                # Instantiate in the GUI widgets from a separate module
                ...
                """
                        ...
                        functionality appearances such as a borderwidth.
                """
...
"""
    ...
    root.mainloop()     #This ensures the Tkinter class obkect, our window, to keep looping
                    #meaning, it will stay open until we instruct it close
"""
