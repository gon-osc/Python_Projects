...
def onSelect(self,event):
    ...
    with conn:
        ...
        # THis returns a tuple and we can slice it into 4 parts[] during the iteration
        for data in varBody :
...
def addToList(self) :
    ...
    var_fname = var_fname.strip() # This will remove any blank spaces and after the user's entry
